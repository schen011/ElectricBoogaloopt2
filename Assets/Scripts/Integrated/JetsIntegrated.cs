...
public class JetsIntegrated : MonoBehaviour
{
    ...
    void LoadModel()
    {
        var model = ModelLoader.Load(Path.Join(Application.streamingAssetsPath ,"/sentis-jets/jets-text-to-speech.sentis"));
    ...
    void ReadDictionary()
    {
        ...
        string[] words = File.ReadAllLines(Path.Join(Application.streamingAssetsPath,"/sentis-jets/phoneme_dict.txt"));
